...
function pickFallbackDefault(profiles: Profile[], removedId: string): string | null {
...
test("pickFallbackDefault returns null when no candidates exist", () => {
	const profiles: Profile[] = [{ id: "p1", isDefault: true, updatedAt: new Date("2026-04-11T10:00:00.000Z") }];
